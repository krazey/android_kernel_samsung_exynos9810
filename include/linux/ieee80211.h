...
#define WLAN_AKM_SUITE_FT_8021X		SUITE(0x000FAC, 3) /* 802.11r */
#define WLAN_AKM_SUITE_FT_PSK		SUITE(0x000FAC, 4) /* 802.11r */
...
#define WLAN_AKM_SUITE_CCKM		SUITE(0x004096, 0)  /* CCKM */
