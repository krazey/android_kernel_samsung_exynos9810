...
#define FS_POLICY_FLAG_IV_INO_LBLK_64	0x08
...
struct fscrypt_policy_v2 {
	...
	__u8 flags;
	__u8 __reserved[4];
	__u8 master_key_identifier[FS_KEY_IDENTIFIER_SIZE];
};
 ...
 */
#define FS_KEY_SPEC_TYPE_DESCRIPTOR	1
 ...
 */
#define FS_KEY_SPEC_TYPE_IDENTIFIER	2
...
struct fscrypt_key_specifier {
	...
	union {
		...
		__u8 descriptor[FS_KEY_DESCRIPTOR_SIZE];
		__u8 identifier[FS_KEY_IDENTIFIER_SIZE];
	} u;
};
